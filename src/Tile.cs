...
public partial class Tile : StaticBody3D
{
    ...
    public bool IsTaken(APawn pawn)
    {
        ...
        {
            GD.Print("Object above name is:" + possiblePawn.PawnName);
            var isPossiblePawnMyPawn = possiblePawn.Equals(pawn);
            GD.Print("Equality:" + isPossiblePawnMyPawn);
            return (!isPossiblePawnMyPawn);
        }
        return false;
    }
